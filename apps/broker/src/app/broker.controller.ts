...
export class BrokerController {
  ...
  async withdraw(dto: { amount: number; brokerCode:string; phoneNumber: string; provider: 'MTN' | 'AIRTEL'; payeeName?: string }) {
    this.logger.log(`withdraw called for phone=${dto.phoneNumber}, amount=${dto.amount}, broker=${dto.brokerCode}`);
  ...
  async getWalletTransactions(dto: { brokerCode: string; page: number; limit: number }) {
    this.logger.log(`getWalletTransactions called for broker=${dto.brokerCode}, page=${dto.page}`);
  ...
  async getSubscriptionDetails(dto: GetSubscriptionDetailsDto) {
    this.logger.log(`getSubscriptionDetails called for broker=${dto.brokerCode}`);
