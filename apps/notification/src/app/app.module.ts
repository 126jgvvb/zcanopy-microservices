...
@Module({
  imports: [
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (config: ConfigService) => ({
        ...
        entities: [NotificationEntity, SupportMessageEntity],
        synchronize: config.get<string>('DB_SYNCHRONIZE') !== 'false',
        logging: config.get<string>('DB_LOGGING') === 'true',
      }),
    }),
    TypeOrmModule.forFeature([NotificationEntity, SupportMessageEntity]),
  ...
  controllers: [AppController, OtpNotificationController, WebhooksController],
